  ...
  return (
    <div>
      <div className="w-96 h-screen relative">
        ...
        <div className="w-80 h-7 left-[92px] top-[204px] absolute text-white text-lg font-semibold uppercase leading-3 tracking-widest">
          mail us
        </div>
        <div className="w-80 h-7 left-[92px] top-[284px] absolute text-white text-lg font-semibold uppercase leading-3 tracking-widest">
          visit instagram
        </div>
        <div className="w-80 h-7 left-[92px] top-[363px] absolute text-white text-lg font-semibold uppercase leading-3 tracking-widest">
          visit youtube
        </div>
        <div className="w-80 h-16 left-[92px] top-[427px] absolute text-white text-lg font-semibold uppercase leading-3 tracking-widest">
          phone
        </div>
