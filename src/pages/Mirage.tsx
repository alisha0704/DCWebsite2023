    ...
    <div className="backdrop-blur-2xl">
      <div className="xl:w-full lg:w-9/10 w-full mx-auto text-left border-solid border-white md:px-2">
        ...
        <div className="text-center text-gray-400 text-sm md:text-md lg:text-md font-normal mb-8 pt-2">
          Mirage is one of the seven teams at VIT dance club, with genres
          ranging from Indo-jazz to contemporary to semi-classical. The
          team&apos;s outstanding and challenging stunts are one of its key
          highlights. The team has won numerous festivals, including spandan,
          IIM, CMC, Atharva, Pulse etc.
        </div>
        ...
        <div className="text-xl md:text-2xl text-center font-extrabold pt-6">
          Mini-Gallery
        </div>
