  ...
  return (
    <>
      ...
      <div className="w-full px-10 gap-12 max-w-screen-lg flex justify-around">
        <Image src="/events/pradeep.svg" alt="Image 1" className="w-1/3" height={100} width={100}/>
        {/* <img src="/Events/pradeep.svg" alt="Image 1" className="w-1/3" /> */}
        <Image src="/events/jishnu.svg" alt="Image 2" className="w-1/3" height={100} width={100}/>
        {/* <img src="/Events/jishnu.svg" alt="Image 2" className="w-1/3" /> */}
        <Image src="/events/raghavan.svg" alt="Image 3" className="w-1/3" height={100} width={100}/>
