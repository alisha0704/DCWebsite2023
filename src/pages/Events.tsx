...
const Events:React.FC<EventsProps> = () => {
    ...
    return (
      ...
      <p className="text-gray-300 text-xl">Brace yourself for a high-octane dose of entertainment.
       Here are the events we performed lately.</p>
    </div>
    ...
    <Carousel
        ...
        >
          <div>
            <img src="/events/riviera1.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/riviera2.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/riviera3.svg" alt="VIT DANCE CLUB" />
          </div>
        </Carousel>
    </div>
  ...
  <div className='text-center ml-12 pl-12 mt-12'>
    <h1 className="text-3xl  text-white font-semibold mb-2">International Dance Day</h1>
    <div className="flex ml-12 pl-12">
    <div className="w-1/3 p-4 pl-12 ml-12 slideshow-container">
    <Carousel
          showThumbs={false}
        ...
        >
          <div>
            <img src="/events/IDD1.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/IDD2.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/IDD3.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/IDD4.svg" alt="VIT DANCE CLUB" />
          </div>
        </Carousel>
    </div>
    <div className="w-1/2 pt-12 mt-12 ">
      <p className="text-gray-300 text-xl">
      IDD is a celebration of all dancers and the art itself and takes <br/>place every year.
      All the teams of the club come together and <br/> put up a thrilling show for our audience.</p>
  ...
  <div className='text-center ml-12 pl-12 mt-12'>
    <h1 className="text-3xl  text-white font-semibold mb-2">World Dance Day</h1>
    <div className="flex ml-12 pl-12">
    <div className="w-1/3 p-4 pl-12 ml-12 slideshow-container">
    <Carousel
          showThumbs={false}
        ...
        >
          <div>
            <img src="/events/WDD1.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/WDD2.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/WDD3.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/WDD4.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/WDD5.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/WDD6.svg" alt="VIT DANCE CLUB" />
          </div>
          <div>
            <img src="/events/WDD7.svg" alt="VIT DANCE CLUB" />
          </div>
        </Carousel>
    </div>
    <div className="w-1/2 pt-12 mt-12 ">
  ...
  <div className="text-center mb-12 py-8">
      <h1 className="text-3xl text-white font-semibold mt-8 mb-4 py-12">Other Events and Workshops</h1>
    </div>
