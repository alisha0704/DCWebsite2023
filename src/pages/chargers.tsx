  ...
  return (
    <div className="xl:w-full lg:w-9/10 w-full mx-auto text-left border-solid border-white px-2 py-2 backdrop-blur-2xl">
      ...
      <div className="text-center text-gray-400 text-sm md:text-md lg:text-md font-normal mb-8">
        A dance group embodying the essence of South Indian rhythms, a perfect
        blend of dappankuthu beats and western moves . With their electrifying
        choreography, energy, synchronicity, and an irresistible dose of swag. A
        team with a decade-strong legacy of unstoppable journey.
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
          ...
          <div className="sm:px-2 md:px-10 ">
            ...
            <div className="md:w-96 text-white text-sm sm:text-base font-normal leading-7 text-center md:text-left justify-center items-center">
              ...
              ode to World Dance Day with our dynamic performance.It is a night
              of breathtaking choreography and boundless creativity as we pay
              homage to the universal language of dance.
            </div>
          ...
          <div className="sm:px-2 md:px-5">
            ...
            <div className="md:px-4 md:pl-6 text-white sm:text-base font-normal leading-7 text-center md:text-left pb-4">
              ...
              it cause we&apos;ve bought international dance day TO YOU! <br />{" "}
          ...
          <div className="p-8">
            <Image
              src="/Chargers/chargersrecent2.svg"
              height={150}
              width={669}
              alt="Chargers"
            />
