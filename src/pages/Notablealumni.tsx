      ...
      <div className="backdrop-blur-2xl backdrop-brightness-100">
        ...
        <div className="py-10">
          ...
          <div className="text-center font-medium text-md max-sm:text-sm px-2 text-gray-400  md:pb-10">
            Check out the list of our Notable Alumni who are on top of their
            Passion.
          </div>
        </div>
        <div className="pb-10">
          <div className="mx-auto relative px-[2vw]">
            ...
            <button
              type="button"
              className="absolute top-0 left-12 lg:left-60 z-30 flex items-center justify-center h-full lg:px-4 cursor-pointer group focus:outline-none"
              data-carousel-prev
            ...
            <button
              type="button"
              className="absolute top-0 right-12 lg:right-60 z-30 flex items-center justify-center h-full lg:px-4 cursor-pointer group focus:outline-none"
              data-carousel-next
