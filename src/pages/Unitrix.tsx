    ...
    <div className="backdrop-blur-2xl">
      <div className="xl:w-full lg:w-9/10 w-full mx-auto text-left border-solid border-white md:px-2">
        ...
        <div className="text-center text-gray-400 text-sm md:text-md lg:text-md font-normal mb-8">
          We are Unitrix, the hip hop crew of VIT Dance Club. We adopt a
          versatile blend of extraordinary styles from popping to locking,
          waacking to electro, house to lite feet and obviously freestyle. We
          are always excited to explore more styles and push outside of our
          comfort zone.
        </div>
