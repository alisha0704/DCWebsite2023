...
const Slideshow: React.FC = () => {
  ...
  const imageTexts = [
    ...
    "Presenting the Presenting, The Board of Dance Club 2023-24
    Know more about the DC Board Members who are the prime backbone of this dance crew.", // Add your text for the second image
  ];
