...
const Slideshow: React.FC = () => {
  ...
  const imageTexts = [
    ...
    "Presenting, the Board of Dance Club 2023-24. Know more about the DC Board Members who are the prime backbone of this dance  ", // Add your text for the second image
  ];
